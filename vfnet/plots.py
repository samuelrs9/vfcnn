...
from voxelizer.plots import Plots2D as VoxelizerPlots

class Plots2D(VoxelizerPlots):
    ...
    def __init__(self,data_reader=None,ndim=None,num_figs=None,voxelizer=None):
        ...
        Args:
            ...
            num_figs:
        """
        super().__init__(data_reader,ndim,num_figs,voxelizer) 
    ...
    def view_simulation(self,labels_config_file=None,section=None,
        initial_step=0,final_step=-1,skip_steps=1,pause=0.1):
        """ 
        ...
        for step in range(initial_step,final_step+1,skip_steps):
            ...
            if labels_config_file != None:
                ...
                labels_config = labels_config.get_labels_config(section)
                labels = self.data_reader.get_step_labels(
                    step,labels_config_file,section=section)
                ...
                plt.legend(labels_config['labels'].split())
            else:
                if self.ndim==2:
